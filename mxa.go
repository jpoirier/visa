...
// DeleteFile Deletes the specified file. name must include the full file path.
...
// CreateFolder Creates a folder. name must include the full path.
...
// ClearTrace Clears/Resets the trace number.
...
// SetCenterFreqKHz Sets the Center Frequency (KHz).
...
// SetCenterFreqMHz Sets the Center Frequency (MHz).
...
// SetCenterFreqGHz Sets the Center Frequency (GHz).
...
// GetCenterFreqMHz Gets the Center Frequency (MHz).
